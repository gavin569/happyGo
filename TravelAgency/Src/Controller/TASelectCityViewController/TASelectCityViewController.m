...
@interface TASelectCityViewController ()<UISearchBarDelegate,UISearchDisplayDelegate>{
...
@implementation TASelectCityViewController
...
- (void)setDataSource:(id<TAddressPickerDataSource>)dataSource{
...
- (BOOL)searchBarShouldBeginEditing:(UISearchBar *)searchBar{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        for (UIView *subview in self.view.subviews){
            subview.transform = CGAffineTransformMakeTranslation(0, -64);
        }
    }];
    return YES;
}
...
#pragma mark - init
- (void)initTableView{
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 108, ScreenWidth, ScreenHeight - 108) style:UITableViewStylePlain];
